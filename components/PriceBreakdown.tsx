    ...
    <div className="sport-card p-5">
      ...
      <div className="space-y-3 text-sm">
        <div className="flex justify-between">
          <span className="text-ink-muted">{t('booking.basePrice')}</span>
        ...
        {discountAmount > 0 && (
          <div className="flex justify-between">
            <span className="text-status-success-text">{t('booking.discount')}</span>
        ...
        {creditUsed > 0 && (
          <div className="flex justify-between">
            <span className="text-info">{t('booking.creditUsed')}</span>
        ...
        <div className="border-t border-border pt-3 flex justify-between items-baseline">
          <span className="text-ink font-semibold">{t('booking.total')}</span>
