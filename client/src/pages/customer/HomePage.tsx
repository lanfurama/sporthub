          ...
          <div className="max-w-6xl mx-auto text-center relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
                ...
                <div className="md:col-span-3 relative">
                  ...
                  <select
                    ...
                    aria-label={t('home.duration', 'Duration')}
            ...
            <div className="mt-10 flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-ink-muted">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium">{t('home.trustVerified', 'Verified courts')}</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <TrendingUp size={16} className="text-info" />
                <span className="font-medium">{t('home.trustInstant', 'Instant booking')}</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <MapPin size={16} className="text-accent" />
                <span className="font-medium">{t('home.trustNearby', 'Nearby locations')}</span>
              </div>
            </div>
          </div>
        </section>
