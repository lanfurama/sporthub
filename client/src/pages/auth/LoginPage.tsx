    ...
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        >
          ...
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.3em]">Nền tảng đặt sân chuyên nghiệp</p>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-2xl font-display font-bold text-white mb-2 uppercase tracking-tight">Đăng nhập</h2>
          <p className="text-xs text-gray-500 mb-8 font-medium">Chào mừng bạn quay trở lại sân đấu!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Mật khẩu</label>
                <a href="#" className="text-[10px] font-bold text-primary hover:underline uppercase tracking-widest">Quên mật khẩu?</a>
              </div>
              <div className="relative">
        ...
        <p className="mt-12 text-center text-[10px] text-gray-600 font-bold uppercase tracking-[0.2em]">
          © 2026 SportHub Platform. Protected System.
        </p>
      </div>
    </div>
  );
